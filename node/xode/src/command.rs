...
fn load_spec(id: &str) -> std::result::Result<Box<dyn ChainSpec>, String> {
	Ok(match id {
		"dev" => Box::new(chain_spec::xode_dev_config()),
		"template-rococo" => Box::new(chain_spec::xode_testnet_config()),
		"" | "local" => Box::new(chain_spec::xode_testnet_config()),
		"live" => Box::new(chain_spec::xode_mainnet_config()),
...
pub fn run() -> Result<()> {
	...
	match &cli.subcommand {
		...
		Some(Subcommand::TryRuntime(cmd)) => {
			use humidefi_runtime::MILLISECS_PER_BLOCK;
